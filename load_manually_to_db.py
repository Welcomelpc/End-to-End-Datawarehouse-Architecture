#WORKING CODE FOR INSERTING MULTIPLES TABLES AT THE SAME TIME
import psycopg2
import pandas as pd
...
if __name__ == "__main__":
    ...
    if conn:
        ...
        product_group_level_4_csv_path = "C:\\Users\\LungeloNkambule\\Documents\\InternshipProject\\2024 G2 Internship Technical Project\\McD Data\\data\\ProductGroupLevel4.csv"
        product_group_level_4_df = read_csv(product_group_level_4_csv_path)
        if product_group_level_4_df is not None:
            insert_data_to_db(conn, product_group_level_4_df, 'StgSales', 'product_group_level_4_stg')
